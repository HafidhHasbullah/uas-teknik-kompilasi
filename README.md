...
- Men-generate label unik untuk awal perulangan (contoh: L1) dan akhir perulangan (L2).

- Mengevaluasi kondisi menggunakan lompatan bersyarat: ifFalse [kondisi] goto L2 (jika kondisi salah, lompat ke akhir).

 - Mengurai body perulangan. Jika terdapat operasi aritmatika (misalnya x - 1), program membuat variabel temporary sementara (misal t1) untuk menampung hasil operasi sebelum disimpan ke variabel target.

- Menambahkan instruksi goto L1 di akhir body untuk mengarahkan eksekusi kembali ke awal loop.
